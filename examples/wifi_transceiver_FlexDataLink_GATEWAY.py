...
# Generated: Thu Feb  1 20:05:53 2018
##################################################
...
class wifi_transceiver_FlexDataLink_GATEWAY(gr.top_block):
    ...
    def __init__(self):
        ...
        self.somac_decision_0 = somac.decision(True, 60, 5)
        ...
        self.msg_connect((self.data_link_0, 'tap out'), (self.foo_wireshark_connector_0_0, 'in'))
