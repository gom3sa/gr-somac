...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_somac_swig')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_somac_swig')
...
class metrics_frame(object):
    """Proxy of C++ gr::somac::metrics_frame class."""
    ...
    def make(mac_addr, mac_addr_coord):
        """make(std::vector< uint8_t,std::allocator< uint8_t > > mac_addr, std::vector< uint8_t,std::allocator< uint8_t > > mac_addr_coord) -> metrics_frame_sptr"""
        return _somac_swig.metrics_frame_make(mac_addr, mac_addr_coord)

    make = staticmethod(make)
    __swig_destroy__ = _somac_swig.delete_metrics_frame
    __del__ = lambda self: None
metrics_frame_swigregister = _somac_swig.metrics_frame_swigregister
metrics_frame_swigregister(metrics_frame)

def metrics_frame_make(mac_addr, mac_addr_coord):
    """metrics_frame_make(std::vector< uint8_t,std::allocator< uint8_t > > mac_addr, std::vector< uint8_t,std::allocator< uint8_t > > mac_addr_coord) -> metrics_frame_sptr"""
    return _somac_swig.metrics_frame_make(mac_addr, mac_addr_coord)

class metrics_frame_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::somac::metrics_frame)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::somac::metrics_frame)> self) -> metrics_frame_sptr
        __init__(boost::shared_ptr<(gr::somac::metrics_frame)> self, metrics_frame p) -> metrics_frame_sptr
        """
        this = _somac_swig.new_metrics_frame_sptr(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __deref__(self):
        """__deref__(metrics_frame_sptr self) -> metrics_frame"""
        return _somac_swig.metrics_frame_sptr___deref__(self)

    __swig_destroy__ = _somac_swig.delete_metrics_frame_sptr
    __del__ = lambda self: None

    def make(self, mac_addr, mac_addr_coord):
        """make(metrics_frame_sptr self, std::vector< uint8_t,std::allocator< uint8_t > > mac_addr, std::vector< uint8_t,std::allocator< uint8_t > > mac_addr_coord) -> metrics_frame_sptr"""
        return _somac_swig.metrics_frame_sptr_make(self, mac_addr, mac_addr_coord)


    def history(self):
        """history(metrics_frame_sptr self) -> unsigned int"""
        return _somac_swig.metrics_frame_sptr_history(self)


    def declare_sample_delay(self, *args):
        """
        declare_sample_delay(metrics_frame_sptr self, int which, int delay)
        declare_sample_delay(metrics_frame_sptr self, unsigned int delay)
        """
        return _somac_swig.metrics_frame_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which):
        """sample_delay(metrics_frame_sptr self, int which) -> unsigned int"""
        return _somac_swig.metrics_frame_sptr_sample_delay(self, which)


    def output_multiple(self):
        """output_multiple(metrics_frame_sptr self) -> int"""
        return _somac_swig.metrics_frame_sptr_output_multiple(self)


    def relative_rate(self):
        """relative_rate(metrics_frame_sptr self) -> double"""
        return _somac_swig.metrics_frame_sptr_relative_rate(self)


    def start(self):
        """start(metrics_frame_sptr self) -> bool"""
        return _somac_swig.metrics_frame_sptr_start(self)


    def stop(self):
        """stop(metrics_frame_sptr self) -> bool"""
        return _somac_swig.metrics_frame_sptr_stop(self)


    def nitems_read(self, which_input):
        """nitems_read(metrics_frame_sptr self, unsigned int which_input) -> uint64_t"""
        return _somac_swig.metrics_frame_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(metrics_frame_sptr self, unsigned int which_output) -> uint64_t"""
        return _somac_swig.metrics_frame_sptr_nitems_written(self, which_output)


    def max_noutput_items(self):
        """max_noutput_items(metrics_frame_sptr self) -> int"""
        return _somac_swig.metrics_frame_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m):
        """set_max_noutput_items(metrics_frame_sptr self, int m)"""
        return _somac_swig.metrics_frame_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self):
        """unset_max_noutput_items(metrics_frame_sptr self)"""
        return _somac_swig.metrics_frame_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(metrics_frame_sptr self) -> bool"""
        return _somac_swig.metrics_frame_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m):
        """set_min_noutput_items(metrics_frame_sptr self, int m)"""
        return _somac_swig.metrics_frame_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self):
        """min_noutput_items(metrics_frame_sptr self) -> int"""
        return _somac_swig.metrics_frame_sptr_min_noutput_items(self)


    def max_output_buffer(self, i):
        """max_output_buffer(metrics_frame_sptr self, int i) -> long"""
        return _somac_swig.metrics_frame_sptr_max_output_buffer(self, i)


    def set_max_output_buffer(self, *args):
        """
        set_max_output_buffer(metrics_frame_sptr self, long max_output_buffer)
        set_max_output_buffer(metrics_frame_sptr self, int port, long max_output_buffer)
        """
        return _somac_swig.metrics_frame_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i):
        """min_output_buffer(metrics_frame_sptr self, int i) -> long"""
        return _somac_swig.metrics_frame_sptr_min_output_buffer(self, i)


    def set_min_output_buffer(self, *args):
        """
        set_min_output_buffer(metrics_frame_sptr self, long min_output_buffer)
        set_min_output_buffer(metrics_frame_sptr self, int port, long min_output_buffer)
        """
        return _somac_swig.metrics_frame_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self):
        """pc_noutput_items(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self):
        """pc_noutput_items_var(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self):
        """pc_nproduced(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self):
        """pc_nproduced_avg(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self):
        """pc_nproduced_var(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_nproduced_var(self)


    def pc_input_buffers_full(self, *args):
        """
        pc_input_buffers_full(metrics_frame_sptr self, int which) -> float
        pc_input_buffers_full(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_input_buffers_full(self, *args)


    def pc_input_buffers_full_avg(self, *args):
        """
        pc_input_buffers_full_avg(metrics_frame_sptr self, int which) -> float
        pc_input_buffers_full_avg(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_input_buffers_full_avg(self, *args)


    def pc_input_buffers_full_var(self, *args):
        """
        pc_input_buffers_full_var(metrics_frame_sptr self, int which) -> float
        pc_input_buffers_full_var(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_input_buffers_full_var(self, *args)


    def pc_output_buffers_full(self, *args):
        """
        pc_output_buffers_full(metrics_frame_sptr self, int which) -> float
        pc_output_buffers_full(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_output_buffers_full(self, *args)


    def pc_output_buffers_full_avg(self, *args):
        """
        pc_output_buffers_full_avg(metrics_frame_sptr self, int which) -> float
        pc_output_buffers_full_avg(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_output_buffers_full_avg(self, *args)


    def pc_output_buffers_full_var(self, *args):
        """
        pc_output_buffers_full_var(metrics_frame_sptr self, int which) -> float
        pc_output_buffers_full_var(metrics_frame_sptr self) -> pmt_vector_float
        """
        return _somac_swig.metrics_frame_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self):
        """pc_work_time(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_work_time(self)


    def pc_work_time_avg(self):
        """pc_work_time_avg(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self):
        """pc_work_time_var(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_work_time_var(self)


    def pc_work_time_total(self):
        """pc_work_time_total(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self):
        """pc_throughput_avg(metrics_frame_sptr self) -> float"""
        return _somac_swig.metrics_frame_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask):
        """set_processor_affinity(metrics_frame_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _somac_swig.metrics_frame_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self):
        """unset_processor_affinity(metrics_frame_sptr self)"""
        return _somac_swig.metrics_frame_sptr_unset_processor_affinity(self)


    def processor_affinity(self):
        """processor_affinity(metrics_frame_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _somac_swig.metrics_frame_sptr_processor_affinity(self)


    def active_thread_priority(self):
        """active_thread_priority(metrics_frame_sptr self) -> int"""
        return _somac_swig.metrics_frame_sptr_active_thread_priority(self)


    def thread_priority(self):
        """thread_priority(metrics_frame_sptr self) -> int"""
        return _somac_swig.metrics_frame_sptr_thread_priority(self)


    def set_thread_priority(self, priority):
        """set_thread_priority(metrics_frame_sptr self, int priority) -> int"""
        return _somac_swig.metrics_frame_sptr_set_thread_priority(self, priority)


    def name(self):
        """name(metrics_frame_sptr self) -> std::string"""
        return _somac_swig.metrics_frame_sptr_name(self)


    def symbol_name(self):
        """symbol_name(metrics_frame_sptr self) -> std::string"""
        return _somac_swig.metrics_frame_sptr_symbol_name(self)


    def input_signature(self):
        """input_signature(metrics_frame_sptr self) -> io_signature_sptr"""
        return _somac_swig.metrics_frame_sptr_input_signature(self)


    def output_signature(self):
        """output_signature(metrics_frame_sptr self) -> io_signature_sptr"""
        return _somac_swig.metrics_frame_sptr_output_signature(self)


    def unique_id(self):
        """unique_id(metrics_frame_sptr self) -> long"""
        return _somac_swig.metrics_frame_sptr_unique_id(self)


    def to_basic_block(self):
        """to_basic_block(metrics_frame_sptr self) -> basic_block_sptr"""
        return _somac_swig.metrics_frame_sptr_to_basic_block(self)


    def check_topology(self, ninputs, noutputs):
        """check_topology(metrics_frame_sptr self, int ninputs, int noutputs) -> bool"""
        return _somac_swig.metrics_frame_sptr_check_topology(self, ninputs, noutputs)


    def alias(self):
        """alias(metrics_frame_sptr self) -> std::string"""
        return _somac_swig.metrics_frame_sptr_alias(self)


    def set_block_alias(self, name):
        """set_block_alias(metrics_frame_sptr self, std::string name)"""
        return _somac_swig.metrics_frame_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(metrics_frame_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _somac_swig.metrics_frame_sptr__post(self, which_port, msg)


    def message_ports_in(self):
        """message_ports_in(metrics_frame_sptr self) -> swig_int_ptr"""
        return _somac_swig.metrics_frame_sptr_message_ports_in(self)


    def message_ports_out(self):
        """message_ports_out(metrics_frame_sptr self) -> swig_int_ptr"""
        return _somac_swig.metrics_frame_sptr_message_ports_out(self)


    def message_subscribers(self, which_port):
        """message_subscribers(metrics_frame_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _somac_swig.metrics_frame_sptr_message_subscribers(self, which_port)

metrics_frame_sptr_swigregister = _somac_swig.metrics_frame_sptr_swigregister
metrics_frame_sptr_swigregister(metrics_frame_sptr)


metrics_frame_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
metrics_frame = metrics_frame.make;
