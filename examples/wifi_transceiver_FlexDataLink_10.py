...
# Title: Wifi Transceiver Flexdatalink 10
# Generated: Mon Sep 24 18:50:01 2018
##################################################
...
class wifi_transceiver_FlexDataLink_10(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Flexdatalink 10")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xbe]
...
def main(top_block_cls=wifi_transceiver_FlexDataLink_10, options=None):
