...
# Generated: Thu Oct 25 17:34:52 2018
##################################################
...
class wifi_transceiver_FlexDataLink_9(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Flexdatalink 9")
...
def main(top_block_cls=wifi_transceiver_FlexDataLink_9, options=None):
