...
# Generated: Thu Feb  8 20:04:04 2018
##################################################
...
class wifi_transceiver_FlexDataLink_4(gr.top_block):
...
def main(top_block_cls=wifi_transceiver_FlexDataLink_4, options=None):
