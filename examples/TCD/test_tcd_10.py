...
# Title: Test Tcd 10
# Generated: Mon Nov 12 10:56:04 2018
##################################################
...
class test_tcd_10(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Test Tcd 10")
        ...
        self.data_link_0 = data_link(
            ...
            mac_coord=mac_coord,
            mac_dst=[0x12,0x34,0x56,0x78,0x90,0xab],
            mac_src=mac_addr,
            portid=255,
            samp_rate=samp_rate,
        )
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.data_link_0.set_samp_rate(self.samp_rate)
...
def main(top_block_cls=test_tcd_10, options=None):
