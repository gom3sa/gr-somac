...
class wifi_FlexDataLink_TG_GATEWAY(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Flexdatalink Tg Gateway")
...
def main(top_block_cls=wifi_FlexDataLink_TG_GATEWAY, options=None):
