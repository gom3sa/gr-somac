...
# Title: Test Tcd 14
# Generated: Mon Nov 12 10:56:12 2018
##################################################
...
class test_tcd_14(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Test Tcd 14")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xcc]
...
def main(top_block_cls=test_tcd_14, options=None):
