...
# Title: Wifi Transceiver Flexdatalink 13
# Generated: Mon Sep 24 18:50:17 2018
##################################################
...
class wifi_transceiver_FlexDataLink_13(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Flexdatalink 13")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xcb]
...
def main(top_block_cls=wifi_transceiver_FlexDataLink_13, options=None):
