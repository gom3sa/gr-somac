...
# Title: Wifi Transceiver Flexdatalink 15
# Generated: Thu Oct 25 17:35:02 2018
##################################################
...
class wifi_transceiver_FlexDataLink_15(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Flexdatalink 15")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xcd]
...
def main(top_block_cls=wifi_transceiver_FlexDataLink_15, options=None):
