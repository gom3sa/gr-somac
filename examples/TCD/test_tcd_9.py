...
# Title: Test Tcd 9
# Generated: Mon Nov 12 10:56:01 2018
##################################################
...
class test_tcd_9(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Test Tcd 9")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xbd]
...
def main(top_block_cls=test_tcd_9, options=None):
