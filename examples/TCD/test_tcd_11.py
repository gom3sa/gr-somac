...
# Title: Test Tcd 11
# Generated: Thu Oct 25 17:38:15 2018
##################################################
...
class test_tcd_11(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Test Tcd 11")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xbf]
...
def main(top_block_cls=test_tcd_11, options=None):
